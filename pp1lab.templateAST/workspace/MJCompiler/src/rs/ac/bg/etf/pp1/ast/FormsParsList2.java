...
public class FormsParsList2 extends FormsParsList {

    private FormsParsList FormsParsList;
    private Type Type;
    private String ParName;

    public FormsParsList2 (FormsParsList FormsParsList, Type Type, String ParName) {
